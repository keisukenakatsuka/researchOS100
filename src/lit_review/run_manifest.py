...
SCRIPT_DEPS: Dict[str, List[str]] = {
    ...
    "089a_hypothesis_selector": ["089"],
    "089b_hypothesis_review": ["089a"],
    "089c_focused_hypotheses": ["089b"],
    "114_hyp_query_expansion": ["089c"],
    "115_hyp_mass_retrieval": ["114"],
    "116_hyp_dedup_rank": ["115"],
    "117_hyp_clustering": ["116"],
    "118_hyp_extraction": ["117"],
    "119_hyp_literature_synthesis": ["118"],
    "090_validation_designer": ["089c"],
...
SCRIPT_OUTPUTS: Dict[str, List[str]] = {
    ...
    "089a_hypothesis_selector": ["hypothesis_selection.json", "hypothesis_selection.md"],
    "089b_hypothesis_review": ["hypothesis_review_decision.json"],
    "089c_focused_hypotheses": ["focused_hypotheses.json", "focused_hypotheses.md"],
    "114_hyp_query_expansion": [],  # outputs under hyp_literature/<hyp_id>/
    "115_hyp_mass_retrieval": [],
    "116_hyp_dedup_rank": [],
    "117_hyp_clustering": [],
    "118_hyp_extraction": [],
    "119_hyp_literature_synthesis": [],
